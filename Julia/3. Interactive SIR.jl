...
# ╔═╡ 9d1e8626-f197-4ff7-81c9-fc1f91321d43
begin
	using Agents
	using Random
	using DataFrames
...
# ╔═╡ c7d5061a-88e6-11ec-2757-793106239e62
md"""
# Introduction
...
# ╔═╡ 4cfa2874-387a-41e1-9bea-1e1c79e68823
md"""
Add Libraries (a.k.a modules)
"""

# ╔═╡ ace1487d-c081-42bb-a73d-6f09a7fca302
md"""
Make functions
"""

# ╔═╡ 8955403e-e7e9-40ea-845d-f2e974cce578
function rate_to_proportion(r::Float64,t::Float64)
    1-exp(-r*t)
end;

# ╔═╡ c95c21e2-a9f3-483c-afb2-adc999ea4c3b
md"""
## Transitions
...
# ╔═╡ deab7d01-b6f6-4f26-8a3c-30e6b79c85d4
mutable struct Person <: AbstractAgent
    id::Int64
    status::Symbol
end

# ╔═╡ 7a30dc86-eb77-4814-a02d-f5ea2d6a7f51
md"""
This utility function sets up the model, by setting parameter fields and adding agents to the model.
"""


# ╔═╡ a1c15870-9cc7-42de-a12a-3eea7137af3c
...
# ╔═╡ 7b1423cc-92e6-4300-acda-4c27e13436e1
md"""
The following function applies a series of functions to each agent.
"""

# ╔═╡ c6e37d7c-faf2-4dc2-877a-954f28b7fa99
md"""
...
# ╔═╡ 7d46d59c-139d-44be-bf47-d9d4b34af73c
...
# ╔═╡ b6d41902-e69c-4866-8c62-5948ef00cdf7
md"""
Recovery function
"""

# ╔═╡ 7c20c8ed-dd74-4d49-856d-5bd87d0a4d11
...
# ╔═╡ e245d6ef-f00e-4271-9d08-e4ecb3952eec
function agent_step!(agent, model)
    transmit!(agent, model)
    recover!(agent, model)
end;

# ╔═╡ f76051ac-51b0-4b49-90c1-709bbe541950
md"""
## Summarize your data
"""

# ╔═╡ 63b3b6df-c736-4e17-8c1e-143473f6c2b9
begin
...
# ╔═╡ a315cf4f-376b-4817-98d0-761a2529751b
md"""
## Time domain
"""

# ╔═╡ 5442bd44-1ce0-4ea2-b5b4-7abb2f7e7aae
begin
	δt = 0.1
	nsteps = 400
	tf = nsteps*δt
...
# ╔═╡ dc8df0ec-c2e0-4242-90f8-f6c5f4a34a3e
md"""
## Parameter values
"""

# ╔═╡ dd9a482a-7cdd-4fcd-8f21-087156511b83
md"""
## Initial conditions
"""

# ╔═╡ 1de56ac7-a217-4a76-8c9d-2f04feb694c6
Random.seed!(1234);

# ╔═╡ 8a2dec66-79d2-4462-8dca-eeb5aee10c89
md"""
# Running the model
"""

# ╔═╡ 8927c911-251e-41dc-862c-852fe5131cc6
md"""
### Change the errors or the sample size and see what happends:

Population size (N) = $(@bind N Slider(10:10:5000, default= 1000,  show_value = true ))

Initial infections (I0)	$(@bind I0 Slider(1:2:50, default= 10,  show_value = true ))

Transmission rate (β) = $(@bind β Slider(0:0.01:1.5, default=0.025, show_value = true ))

Recovery rate (r) = $(@bind r Slider(0:0.01:1.5, default= 0.02,  show_value = true )) 


"""

# ╔═╡ 434508d5-ec2c-45cc-a8c4-8d10c129d688
begin
	#β = 0.05
	c = 10.0*δt
	#r=0.25
	γ = rate_to_proportion(r,δt)
end;

# ╔═╡ 018faa63-6b45-446f-93d3-89e865f700f8
begin
...
# ╔═╡ a679ace8-c553-4c30-a428-30cedbf88059
md"""
# Plotting
"""

# ╔═╡ 14e08020-ce63-4823-97b9-0508e177da7b
begin
...
manifest_format = "2.0"
project_hash = "9580dc4e3a5a388120a90f1f40e3ff9d4d3ae013"
...
git-tree-sha1 = "7a94d64cc5608a6c23de7cbfe8b27de0dc4566f0"
...
[[deps.protoc_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl", "Pkg"]
git-tree-sha1 = "e18ac87b6080d3fa40253cb898f4b8c075d866be"
